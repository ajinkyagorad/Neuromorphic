...
DATASET= 'TI46-IF.mat';%DATASET= 'digitdata.mat';
%% save file names
...
dt = 1E-3;
% Training Parameters
Nfold = 5; Nepochs = 200; samplesPerSpeakerPerClass=10; numSpeakers=5; samplesPerClass = numSpeakers*samplesPerSpeakerPerClass;
 fracResIn=1;
% END PARAM1s